      ...
      for (var i = 0; i < layer.getSubLayerCount(); i++) {
        var sublayer = layer.getSubLayer(i);
          ...
          layer.leafletMap.viz.addOverlay({
            type: 'tooltip',
            layer: sublayer,
            template: '<div class="cartodb-tooltip-content-wrapper"> <!-- class="cartodb-tooltip-content-wrapper"    content.data contains the field info --> <b>District: </b>{{distname}}<br><b>Total Placements: </b>{{total_daep_placements}}<br><b>Asian Student placements:</b>{{e_daep_placements_asian}}</p></div>',
