...
!function (t, e) {
    L.Pattern = L.Class.extend({
        ...
        addPattern: function (t) {
            ...
            var e = L.stamp(t);
            return this._patterns[e] ? (this._loaded && t.onRemove(this), t.getEvents && this.off(t.getEvents(), t), delete this._patterns[e], this._loaded && (this.fire("patternremove", {pattern: t}), t.fire("remove")), t._map = null, this) : this
        ...
        _createElement: function (t) {
            ...
            var t = this._dom, e = this.options;
            if (t) {
        ...
        options: {x: 0, y: 0, radius: 0}, _initDom: function () {
        ...
        options: {x: 0, y: 0, width: 10, height: 10}, _initDom: function () {
