...
apple = pd.read_csv('../data/from_agency/TX2016.csv') # put the name of the discipline actions file here
district = pd.read_csv('../data/from_agency/district2016.csv') # put the name of the district demographics file here
